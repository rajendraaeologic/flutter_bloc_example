...
import 'package:form_validation/form_validation/model/email.dart';
import 'package:form_validation/form_validation/model/password.dart';
...
class FormValidationBloc extends Bloc<FormValidationEvent, FormValidationState> {
  ...
  @override
  Stream<FormValidationState> mapEventToState(FormValidationEvent event) async* {
